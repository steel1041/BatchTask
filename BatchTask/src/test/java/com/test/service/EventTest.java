 ...
 */
public class EventTest extends Scenario {
    ...
    public void testEventFilter() throws Exception {
        ...
        String transactionHash = sendTransaction(ALICE, CONTRACT_ADDRESS, GAS_LIMIT, encodedFunction);
...
//                new Uint256(BigInteger.valueOf(7)), new Uint256(BigInteger.valueOf(13)))));
        ...
        for (EthLog.LogResult logResult:filterLogs) {
            logger.info(filterLogs.toString());
        }
    }
